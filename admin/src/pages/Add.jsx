...
export const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmitHandler}>
      ...
      <div className='w-full'>
        <p className='mb-2'>Product name</p>
        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2 ' type="text" placeholder='Type Content Here'></textarea>
      </div>
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        <div>
          <p className='mb-2'>Product Category</p>
          <select onChange={(e)=>setCategory(e.target.value)} className='w-[250px] px-3 py-2'>
        ...
        <div>
          ...
          <select onChange={(e)=>setSubCategory(e.target.value)} className='w-[250px] px-3 py-2'>
        ...
        <div>
          ...
          <input onChange={(e)=>setPrice(e.target.value)} value={price} className='w-[250px] px-3 py-2' type="Number" placeholder='25'/>
        </div>
      </div>
